        ...
        scheduler_map = {
            ...
            "wsd": lambda opt, lr: torch.optim.lr_scheduler.LambdaLR(
                ...
                wsd_schedule(
                    ...
                    init_div_factor=cfg.div_factor,
                    final_lr_factor=cfg.final_div_factor,
                ...
                if scheduler_cls:
                    if cfg.scheduler in ["cos", "linear"]:
                        scheduler = scheduler_cls(
                            ...
                            max_lr=getattr(cfg, lr_key.lower()),
                        ...
                        scheduler = scheduler_cls(
                            optimizer, 
                            #group.get(lr_key, getattr(cfg, lr_key.lower()))
                            getattr(cfg, lr_key.lower()),
                        )
